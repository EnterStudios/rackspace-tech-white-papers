...
# Purpose: Identify all *md files in WP repo where the audit date is after
# begin date passed in with script call and before end date passed in with
# script call
#
#
#
...
#       your local WP git repo.
#
# Process:
# 1) Get the dates to compare from the arguments passed in
# 2) Go to WP repo content directory (assumption is you are in the scripts dir)
